...
if __name__=='__main__':
    ...
    indComputer = IndexComputer(expls, len(features), features, path1,p_features,neg_features,map_b)
    indComputer.get_indice_values()
    ...
    features = "age,two_year_recid,priors_count,length_of_stay,c_charge_degree_F,c_charge_degree_M,sex_Female,sex_Male,race,unrelated_column_one,unrelated_column_two"
    ...
    path1 = "data/compas_shapood_nbestim_100_maxdepth_3_testsplit_0.0.mod_nbestim_100_maxdepth_3_testsplit_0.0/o_expls.pkl"
    ...
    path1 = "data/compas_shapood1_nbestim_100_maxdepth_3_testsplit_0.0.mod_nbestim_100_maxdepth_3_testsplit_0.0/o_expls.pkl"
